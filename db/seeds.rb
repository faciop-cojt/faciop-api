...
Good.create({
  ...
  data: 'https://github.com/faciop-cojt/faciop-api/blob/master/img/hmd.glb?raw=true',
  price: '50000',
  category: 'メガネ',
...
Good.create({
  ...
  shopid: rand_3,
  description: 'カワイイ眼鏡❤',
  data: 'https://github.com/faciop-cojt/faciop-api/blob/master/img/glasses_formal_size_fixed_pink.glb?raw=true',
  price: '18000',
  category: 'メガネ',
  link: 'https://www.amazon.co.jp/',
